async function displayResults() {
    try {
        ...
        const selectedRoutes = await response.json();
            ...
            selectedRoutes.forEach((route) => {
                if (route.from.toLowerCase() === retrive.from.toLowerCase() && 
                    ...
                    routeDisplay.innerHTML = `
                            ...
                            <div class="route-time">${route.from.toUpperCase()}  -  <span style="color:red">TO</span>  -  ${route.end.toUpperCase()}</div>
                        ...
                        <div>
                            <button class="bookticket btn btn-danger" id="Bookticket"  style="color:"${route.Bus}>Book tickets</button>
